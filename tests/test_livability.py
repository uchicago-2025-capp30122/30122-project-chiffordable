...
from extracting.livability import make_table_request, livindex_by_zc
...
@patch("extracting.livability.httpx.Client.get")

def test_make_table_request_success(mock_get, mock_response):
    """
...
@patch("extracting.libavility.httpx.make_table_request")
...
def test_livindex_by_zc_invalid_zip(mock_make_table_request):
    ...
    make_table_request.sideeffect = [None]
