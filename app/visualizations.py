...
def create_combined_figure(annual_income, share_on_rent):
    ...
    fig.update_layout(
        mapbox_style="open-street-map", coloraxis_colorbar=dict(title="Median rent")
    )
...
def age_figure(dataframe):
    ...
    figure.update_layout(showlegend=False, plot_bgcolor="white")
